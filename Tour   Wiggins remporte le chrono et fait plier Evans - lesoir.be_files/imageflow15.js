...
function ImageFlow ()
{
	...
	this.refresh = function()
	{
		...
		for (var index = 0; index < max; index++)
		{
			...
			if(image !== null && image.nodeType == 1 && image.nodeName == 'IMG')
			{
				...
				image.explication = image.getAttribute('alt');
	...
	this.glideTo = function(imageID)
	{
		...
		/* Display new caption */
		var caption = my.imagesDiv.childNodes[imageID].getAttribute('title');
		...
		var explication = my.imagesDiv.childNodes[imageID].getAttribute('alt');
		zoom(explication);
